...
address_port = os.environ.get("gcp_address").split(':')
LOGGER.info(address_port)
gcp_address = address_port[0]
gcp_port = address_port[1]

conn = rpyc.connect(gcp_address, gcp_port)
